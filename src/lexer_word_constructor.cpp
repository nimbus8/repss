...
{
    //...
    return wordrepr_and_transition_Pair_t(std::pair<lexer_word_repr *, AggregatePtrsAndDelete<lexer_dfa *> *>(nullptr,nullptr), new AggregateDfaTransitionsAndDelete<DfaTransition*>(1,nullptr));
}
