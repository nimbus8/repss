...
What is repss?
  ...
  a well defined structure from the start, most - if not everything else - will just fall into place (NOTE: I should add that it may /[(*:|have::)] just /[(: :|::(as easily)::)] /[(:: spiralled out of control in it's descent toward|:have all went to)] hell (very quickly) if it hadn't!) 
