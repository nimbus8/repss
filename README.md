...
What is repss?
  ...
  *It's either this or rap.
  ...
  In my view, so long as the principle ideas are sound, and there's a well defined structure (present) from the start (the beginning),most
   -- if not everything else -- will just fall into place.
